...
void buildTransform(double x, double y, double z, double roll, double pitch, double yaw, string parent, string child){
    static tf::TransformBroadcaster br;
...
int main(int argc, char **argv)
{
    ...
    while(ros::ok())
    {
        ...
        */
        ...
        buildTransform(0.628, 0, 0, 0, 0, M_PI, "gripperbot_base", "cambot_base");
        ...
        */
        ...
        buildTransform(0.263, -0.32, 0.26, 0, 0, 0, "gripperbot_base", "GREEN_CONTAINER_0");
        buildTransform(0.143, -0.32, 0.26, 0, 0, 0, "gripperbot_base", "RED_CONTAINER_0");
