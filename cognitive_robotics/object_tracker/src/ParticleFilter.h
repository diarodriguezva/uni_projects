...
public:
    ...
    bool REINIT_ENABLE;
    double REINIT_THRESHOLD;
    float REINIT_TRANS_X_STD;
    float REINIT_TRANS_Y_STD;
    float REINIT_TRANS_SCALE_STD;
};
...
public:
    ...
    bool isReInitEnable()
    {
        return mParams.REINIT_ENABLE;
    }

    double getReInitThreshold()
    {
        return mParams.REINIT_THRESHOLD;
    }
