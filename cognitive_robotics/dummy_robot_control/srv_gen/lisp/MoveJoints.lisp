...
(cl:defmethod cl:initialize-instance :after ((m <MoveJoints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveJoints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dummy_robot_control-srv:<MoveJoints-request> is deprecated: use dummy_robot_control-srv:MoveJoints-request instead.")))

(cl:ensure-generic-function 'q0-val :lambda-list '(m))
(cl:defmethod q0-val ((m <MoveJoints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dummy_robot_control-srv:q0-val is deprecated.  Use dummy_robot_control-srv:q0 instead.")
  (q0 m))

(cl:ensure-generic-function 'q1-val :lambda-list '(m))
(cl:defmethod q1-val ((m <MoveJoints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dummy_robot_control-srv:q1-val is deprecated.  Use dummy_robot_control-srv:q1 instead.")
  (q1 m))

(cl:ensure-generic-function 'q2-val :lambda-list '(m))
(cl:defmethod q2-val ((m <MoveJoints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dummy_robot_control-srv:q2-val is deprecated.  Use dummy_robot_control-srv:q2 instead.")
  (q2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveJoints-request>)))
  ...
  "dummy_robot_control/MoveJointsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveJoints-request)))
  "Returns string type for a service object of type 'MoveJoints-request"
  "dummy_robot_control/MoveJointsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MoveJoints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveJoints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dummy_robot_control-srv:<MoveJoints-response> is deprecated: use dummy_robot_control-srv:MoveJoints-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <MoveJoints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dummy_robot_control-srv:success-val is deprecated.  Use dummy_robot_control-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveJoints-response>)))
  ...
  "dummy_robot_control/MoveJointsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveJoints-response)))
  "Returns string type for a service object of type 'MoveJoints-response"
  "dummy_robot_control/MoveJointsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveJoints)))
  ...
  "dummy_robot_control/MoveJoints")