...
(cl:defmethod cl:initialize-instance :after ((m <find_balls-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'find_balls-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name world-srv:<find_balls-request> is deprecated: use world-srv:find_balls-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <find_balls-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'find_balls-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name world-srv:<find_balls-response> is deprecated: use world-srv:find_balls-response instead.")))
