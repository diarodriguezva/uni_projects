...
(cl:defmethod cl:initialize-instance :after ((m <find_boxes-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'find_boxes-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name world-srv:<find_boxes-request> is deprecated: use world-srv:find_boxes-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <find_boxes-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'find_boxes-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name world-srv:<find_boxes-response> is deprecated: use world-srv:find_boxes-response instead.")))

(cl:ensure-generic-function 'x_min-val :lambda-list '(m))
(cl:defmethod x_min-val ((m <find_boxes-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader world-srv:x_min-val is deprecated.  Use world-srv:x_min instead.")
  (x_min m))

(cl:ensure-generic-function 'x_max-val :lambda-list '(m))
(cl:defmethod x_max-val ((m <find_boxes-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader world-srv:x_max-val is deprecated.  Use world-srv:x_max instead.")
  (x_max m))

(cl:ensure-generic-function 'y_min-val :lambda-list '(m))
(cl:defmethod y_min-val ((m <find_boxes-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader world-srv:y_min-val is deprecated.  Use world-srv:y_min instead.")
  (y_min m))

(cl:ensure-generic-function 'y_max-val :lambda-list '(m))
(cl:defmethod y_max-val ((m <find_boxes-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader world-srv:y_max-val is deprecated.  Use world-srv:y_max instead.")
  (y_max m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <find_boxes-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader world-srv:color-val is deprecated.  Use world-srv:color instead.")
  (color m))
