...
public class REStreamingAudioPlayer implements AudioPlayer {
	...
	private Semaphore openLineSemaphore;
	...
	/**
	 * Constructs a default REStreamingAudioPlayer
	 */
	public REStreamingAudioPlayer() {
		openLineSemaphore = new Semaphore(0);
	 ...
	 * 
	 * [[[ WORKAROUND TODO The "Thread.sleep(cancelDelay)" is added to fix a
	 * problem in the FreeTTSEmacspeak demo. The problem was that the engine
	 * would stutter after using it for a while. Adding this sleep() fixed the
	 * problem. If we later find out that this problem no longer exists, we
	 * should remove the thread.sleep(). ]]]
	 */
	@Override
	public void cancel() {
