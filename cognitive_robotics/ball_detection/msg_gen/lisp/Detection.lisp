...
(cl:defmethod cl:initialize-instance :after ((m <Detection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ball_detection-msg:<Detection> is deprecated: use ball_detection-msg:Detection instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_detection-msg:x-val is deprecated.  Use ball_detection-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_detection-msg:y-val is deprecated.  Use ball_detection-msg:y instead.")
  (y m))
