...
int Util::getNumberOfActors(const ros_tum_msgs::ActorVec& actors)
{
    return actors.ActorVec.size();
}

bool Util::getActorPose(const ros_tum_msgs::ActorVec& actors,
...
bool Util::getActorsOfType(const ros_tum_msgs::ActorVec& actors,
                           const std::string& targetType,
...
bool Util::isPresent(const ros_tum_msgs::ActorVec& actors,
                     const std::string& targetType,
                     const std::string& targetProperty,
                     const int& targetId)
{
...
//bool Util::getActor(const ros_tum_msgs::ActorVec& actors,
                    ...
                    ros_tum_msgs::Actor& output)
{
    ...
    for(int t=0; t<actors.ActorVec.size(); ++t)
    {
        if( actors.ActorVec[t].targetType.compare(targetType.c_str()) == 0)
        {
            copyActorData(actors.ActorVec[t], output);
            found=true;
            break;
...
void Util::copyActorData(const ros_tum_msgs::Actor& src, ros_tum_msgs::Actor& dst)
{
...
void Util::copyActorDataContainer(const ros_tum_msgs::ActorVec& src, ros_tum_msgs::ActorVec& dst)
{
...
void Util::clearActorsDataContainer(ros_tum_msgs::ActorVec& data)
{
...
void Util::clearActionData(ros_tum_msgs::ActionVec& data)
{
