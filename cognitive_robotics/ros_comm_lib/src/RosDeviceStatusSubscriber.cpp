#include "RosDeviceStatusSubscriber.h"
...
void RosDeviceStatusSubscriber::deviceStatusCallback(const ros_tum_msgs::DeviceStatusConstPtr& data)
{
    this->setDeviceStatus(data);
}

void RosDeviceStatusSubscriber::setDeviceStatus(const ros_tum_msgs::DeviceStatusConstPtr& data)
{
...
void RosDeviceStatusSubscriber::getDeviceStatus(ros_tum_msgs::DeviceStatus& data)
{
