...
static void initialize_c1_InverseDynamics(SFc1_InverseDynamicsInstanceStruct
  *chartInstance);
static void initialize_params_c1_InverseDynamics
  (SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void enable_c1_InverseDynamics(SFc1_InverseDynamicsInstanceStruct
  *chartInstance);
static void disable_c1_InverseDynamics(SFc1_InverseDynamicsInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_InverseDynamics
  (SFc1_InverseDynamicsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_InverseDynamics
  (SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void set_sim_state_c1_InverseDynamics(SFc1_InverseDynamicsInstanceStruct *
  chartInstance, const mxArray *c1_st);
static void finalize_c1_InverseDynamics(SFc1_InverseDynamicsInstanceStruct
  *chartInstance);
static void sf_gateway_c1_InverseDynamics(SFc1_InverseDynamicsInstanceStruct
  *chartInstance);
static void initSimStructsc1_InverseDynamics(SFc1_InverseDynamicsInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, const mxArray *c1_y, const char_T *c1_identifier, real_T
  c1_b_y[9]);
static void c1_b_emlrt_marshallIn(SFc1_InverseDynamicsInstanceStruct
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static void c1_sqrtm(SFc1_InverseDynamicsInstanceStruct *chartInstance, real_T
                     c1_A[9], creal_T c1_X[9]);
static void c1_schur(SFc1_InverseDynamicsInstanceStruct *chartInstance, real_T
                     c1_A[9], creal_T c1_V[9], creal_T c1_T[9]);
static void c1_eml_switch_helper(SFc1_InverseDynamicsInstanceStruct
  *chartInstance);
static void c1_eml_scalar_eg(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_threshold(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static real_T c1_abs(SFc1_InverseDynamicsInstanceStruct *chartInstance, real_T
                     c1_x);
static void c1_realmin(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static real_T c1_eml_xnrm2(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[9], int32_T c1_ix0);
static void c1_check_forloop_overflow_error(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, boolean_T c1_overflow);
static void c1_eps(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_eml_eps(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_eml_xscal(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_a, real_T c1_x[9], int32_T c1_ix0, real_T c1_b_x[9]);
static void c1_b_threshold(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_eml_matlab_zlarf(SFc1_InverseDynamicsInstanceStruct
...
static void c1_eml_xgemv(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_m, int32_T c1_n, real_T c1_A[9], int32_T c1_ia0, real_T c1_x[9],
  int32_T c1_ix0, real_T c1_y[3], real_T c1_b_y[3]);
static void c1_c_threshold(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_d_threshold(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_b_eml_matlab_zlarf(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, int32_T c1_iv0, real_T c1_tau,
  ...
  c1_b_work[3]);
static void c1_b_eml_xgemv(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_m, int32_T c1_n, real_T c1_A[9], int32_T c1_ia0, real_T c1_x[9],
  int32_T c1_ix0, real_T c1_y[3], real_T c1_b_y[3]);
static void c1_eml_matlab_zunghr(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, real_T c1_A[9], real_T c1_tau[2], real_T c1_b_A[9]);
static void c1_eml_dlahqr(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  real_T c1_h[9], real_T c1_z[9], real_T c1_b_h[9], int32_T *c1_info, real_T
  c1_b_z[9]);
static real_T c1_sqrt(SFc1_InverseDynamicsInstanceStruct *chartInstance, real_T
                      c1_x);
static void c1_eml_error(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_eml_matlab_zlarfg(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_alpha1, real_T c1_x[3], real_T
  *c1_b_alpha1, real_T c1_b_x[3], real_T *c1_tau);
static real_T c1_b_eml_xnrm2(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[3]);
static void c1_b_eml_xscal(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_a, real_T c1_x[3], real_T c1_b_x[3]);
static void c1_eml_dlanv2(SFc1_InverseDynamicsInstanceStruct *chartInstance,
...
static void c1_c_eml_scalar_eg(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_b_eps(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_eml_xrot(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[9], int32_T c1_ix0, int32_T c1_iy0, real_T c1_c,
  real_T c1_s, real_T c1_b_x[9]);
static void c1_e_threshold(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_b_eml_xrot(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[9], int32_T c1_ix0, int32_T c1_iy0, real_T c1_c,
  real_T c1_s, real_T c1_b_x[9]);
static void c1_c_eml_xrot(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  real_T c1_x[9], int32_T c1_ix0, int32_T c1_iy0, real_T c1_c, real_T c1_s,
  real_T c1_b_x[9]);
static void c1_rsf2csf(SFc1_InverseDynamicsInstanceStruct *chartInstance, real_T
  c1_Ur[9], real_T c1_Tr[9], creal_T c1_U[9], creal_T c1_T[9]);
static void c1_b_eml_dlanv2(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  real_T c1_a, real_T c1_b, real_T c1_c, real_T c1_d, real_T *c1_rt1r, real_T
  *c1_rt1i);
static void c1_scalarEg(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_eml_warning(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_d_eml_scalar_eg(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static boolean_T c1_isUTmatD(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  creal_T c1_T[9]);
static creal_T c1_b_sqrt(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  creal_T c1_x);
static void c1_realmax(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_e_eml_scalar_eg(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static void c1_eml_xgemm(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  creal_T c1_A[9], creal_T c1_B[9], creal_T c1_C[9], creal_T c1_b_C[9]);
static void c1_b_eml_warning(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static real_T c1_abs1(SFc1_InverseDynamicsInstanceStruct *chartInstance, creal_T
                      c1_x);
static void c1_c_eml_warning(SFc1_InverseDynamicsInstanceStruct *chartInstance);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_InverseDynamics, const char_T
  *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_eml_xscal(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_a, real_T c1_x[9], int32_T c1_ix0);
static void c1_c_eml_matlab_zlarf(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, int32_T c1_n, int32_T c1_iv0, real_T c1_tau, real_T c1_C[9],
  int32_T c1_ic0, real_T c1_work[3]);
static void c1_c_eml_xgemv(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_m, int32_T c1_n, real_T c1_A[9], int32_T c1_ia0, real_T c1_x[9],
  int32_T c1_ix0, real_T c1_y[3]);
static void c1_d_eml_matlab_zlarf(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, int32_T c1_iv0, real_T c1_tau,
  real_T c1_C[9], int32_T c1_ic0, real_T c1_work[3]);
static void c1_d_eml_xgemv(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_m, int32_T c1_n, real_T c1_A[9], int32_T c1_ia0, real_T c1_x[9],
  int32_T c1_ix0, real_T c1_y[3]);
static void c1_b_eml_matlab_zunghr(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, real_T c1_A[9], real_T c1_tau[2]);
static int32_T c1_b_eml_dlahqr(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  real_T c1_h[9], real_T c1_z[9]);
static void c1_c_sqrt(SFc1_InverseDynamicsInstanceStruct *chartInstance, real_T *
                      c1_x);
static real_T c1_b_eml_matlab_zlarfg(SFc1_InverseDynamicsInstanceStruct
  *chartInstance, int32_T c1_n, real_T *c1_alpha1, real_T c1_x[3]);
static void c1_d_eml_xscal(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_a, real_T c1_x[3]);
static void c1_c_eml_dlanv2(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  real_T *c1_a, real_T *c1_b, real_T *c1_c, real_T *c1_d, real_T *c1_rt1r,
  real_T *c1_rt1i, real_T *c1_rt2r, real_T *c1_rt2i, real_T *c1_cs, real_T
  *c1_sn);
static void c1_d_eml_xrot(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[9], int32_T c1_ix0, int32_T c1_iy0, real_T c1_c,
  real_T c1_s);
static void c1_e_eml_xrot(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[9], int32_T c1_ix0, int32_T c1_iy0, real_T c1_c,
  real_T c1_s);
static void c1_f_eml_xrot(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  real_T c1_x[9], int32_T c1_ix0, int32_T c1_iy0, real_T c1_c, real_T c1_s);
static void c1_d_sqrt(SFc1_InverseDynamicsInstanceStruct *chartInstance, creal_T
                      *c1_x);
static void c1_b_eml_xgemm(SFc1_InverseDynamicsInstanceStruct *chartInstance,
  creal_T c1_A[9], creal_T c1_B[9], creal_T c1_C[9]);
static void init_dsm_address_info(SFc1_InverseDynamicsInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_InverseDynamics = 0U;
}
  ...
  (SFc1_InverseDynamicsInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_InverseDynamics;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_InverseDynamics = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_InverseDynamics");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_InverseDynamics(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_InverseDynamicsInstanceStruct *chartInstance;
  chartInstance = (SFc1_InverseDynamicsInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_InverseDynamics_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_InverseDynamics), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_InverseDynamics);
  return c1_y;
}
...
void sf_c1_InverseDynamics_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_InverseDynamics_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_InverseDynamics_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_InverseDynamics_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_InverseDynamics(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_InverseDynamics\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_InverseDynamics_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_InverseDynamicsInstanceStruct *)
...
static void sf_opaque_initialize_c1_InverseDynamics(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_InverseDynamicsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
    chartInstanceVar);
  initialize_c1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_InverseDynamics(void *chartInstanceVar)
{
  enable_c1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_InverseDynamics(void *chartInstanceVar)
{
  disable_c1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_InverseDynamics(void *chartInstanceVar)
{
  sf_gateway_c1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_InverseDynamics(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_InverseDynamics
    ((SFc1_InverseDynamicsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_InverseDynamics();/* state var info */
...
extern void sf_internal_set_sim_state_c1_InverseDynamics(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_InverseDynamics();/* state var info */
  ...
  set_sim_state_c1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_InverseDynamics(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_InverseDynamics(S);
}

static void sf_opaque_set_sim_state_c1_InverseDynamics(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_InverseDynamics(S, st);
}

static void sf_opaque_terminate_c1_InverseDynamics(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_InverseDynamicsInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_InverseDynamics((SFc1_InverseDynamicsInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_InverseDynamics(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_InverseDynamics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_InverseDynamics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_InverseDynamics(SimStruct *S)
{
  SFc1_InverseDynamicsInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_InverseDynamicsInstanceStruct *)utMalloc(sizeof
    (SFc1_InverseDynamicsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_InverseDynamicsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_InverseDynamics;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_InverseDynamics;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_InverseDynamics;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_InverseDynamics;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_InverseDynamics;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_InverseDynamics;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_InverseDynamics;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_InverseDynamics;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_InverseDynamics;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_InverseDynamics;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_InverseDynamics;
...
void c1_InverseDynamics_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_InverseDynamics(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_InverseDynamics(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_InverseDynamics(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_InverseDynamics_method_dispatcher.\n"
