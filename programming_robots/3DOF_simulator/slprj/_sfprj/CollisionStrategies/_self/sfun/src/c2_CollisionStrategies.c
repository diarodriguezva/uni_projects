...
static void initialize_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void initialize_params_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void enable_c2_CollisionStrategies(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static void disable_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void set_sim_state_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void sf_gateway_c2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void initSimStructsc2_CollisionStrategies
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier, real_T
  c2_b_y[9]);
static void c2_b_emlrt_marshallIn(SFc2_CollisionStrategiesInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_sqrtm(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
                     real_T c2_A[9], creal_T c2_X[9]);
static void c2_schur(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
                     real_T c2_A[9], creal_T c2_V[9], creal_T c2_T[9]);
static void c2_eml_switch_helper(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static void c2_eml_scalar_eg(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static void c2_threshold(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static real_T c2_abs(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
                     real_T c2_x);
static void c2_realmin(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static real_T c2_eml_xnrm2(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[9], int32_T c2_ix0);
static void c2_check_forloop_overflow_error
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance, boolean_T c2_overflow);
static void c2_eps(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_eml_eps(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_eml_xscal(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x[9], int32_T c2_ix0, real_T c2_b_x[9]);
static void c2_b_threshold(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_eml_matlab_zlarf(SFc2_CollisionStrategiesInstanceStruct
...
static void c2_eml_xgemv(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_m, int32_T c2_n, real_T c2_A[9], int32_T c2_ia0, real_T c2_x[9],
  int32_T c2_ix0, real_T c2_y[3], real_T c2_b_y[3]);
static void c2_c_threshold(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static void c2_d_threshold(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_b_eml_matlab_zlarf(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, int32_T c2_iv0, real_T c2_tau,
  ...
  c2_b_work[3]);
static void c2_b_eml_xgemv(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_m, int32_T c2_n, real_T c2_A[9], int32_T c2_ia0, real_T c2_x[9],
  int32_T c2_ix0, real_T c2_y[3], real_T c2_b_y[3]);
static void c2_eml_matlab_zunghr(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, real_T c2_A[9], real_T c2_tau[2], real_T c2_b_A[9]);
static void c2_eml_dlahqr(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  real_T c2_h[9], real_T c2_z[9], real_T c2_b_h[9], int32_T *c2_info, real_T
  c2_b_z[9]);
static real_T c2_sqrt(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
                      real_T c2_x);
static void c2_eml_error(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_eml_matlab_zlarfg(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_alpha1, real_T c2_x[3], real_T
  *c2_b_alpha1, real_T c2_b_x[3], real_T *c2_tau);
static real_T c2_b_eml_xnrm2(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[3]);
static void c2_b_eml_xscal(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x[3], real_T c2_b_x[3]);
static void c2_eml_dlanv2(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
...
static void c2_c_eml_scalar_eg(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static void c2_b_eps(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_eml_xrot(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[9], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c,
  real_T c2_s, real_T c2_b_x[9]);
static void c2_e_threshold(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_b_eml_xrot(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[9], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c,
  real_T c2_s, real_T c2_b_x[9]);
static void c2_c_eml_xrot(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  real_T c2_x[9], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c, real_T c2_s,
  real_T c2_b_x[9]);
static void c2_rsf2csf(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  real_T c2_Ur[9], real_T c2_Tr[9], creal_T c2_U[9], creal_T c2_T[9]);
static void c2_b_eml_dlanv2(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, real_T c2_a, real_T c2_b, real_T c2_c, real_T c2_d, real_T
  *c2_rt1r, real_T *c2_rt1i);
static void c2_scalarEg(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_eml_warning(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static boolean_T c2_isUTmatD(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, creal_T c2_T[9]);
static creal_T c2_b_sqrt(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  creal_T c2_x);
static void c2_realmax(SFc2_CollisionStrategiesInstanceStruct *chartInstance);
static void c2_e_eml_scalar_eg(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static void c2_eml_xgemm(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  creal_T c2_A[9], creal_T c2_B[9], creal_T c2_C[9], creal_T c2_b_C[9]);
static void c2_b_eml_warning(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static real_T c2_abs1(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
                      creal_T c2_x);
static void c2_c_eml_warning(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_CollisionStrategies, const
  char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_eml_xscal(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x[9], int32_T c2_ix0);
static void c2_c_eml_matlab_zlarf(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, int32_T c2_n, int32_T c2_iv0, real_T c2_tau, real_T c2_C[9],
  int32_T c2_ic0, real_T c2_work[3]);
static void c2_c_eml_xgemv(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_m, int32_T c2_n, real_T c2_A[9], int32_T c2_ia0, real_T c2_x[9],
  int32_T c2_ix0, real_T c2_y[3]);
static void c2_d_eml_matlab_zlarf(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, int32_T c2_m, int32_T c2_n, int32_T c2_iv0, real_T c2_tau,
  real_T c2_C[9], int32_T c2_ic0, real_T c2_work[3]);
static void c2_d_eml_xgemv(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_m, int32_T c2_n, real_T c2_A[9], int32_T c2_ia0, real_T c2_x[9],
  int32_T c2_ix0, real_T c2_y[3]);
static void c2_b_eml_matlab_zunghr(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, real_T c2_A[9], real_T c2_tau[2]);
static int32_T c2_b_eml_dlahqr(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, real_T c2_h[9], real_T c2_z[9]);
static void c2_c_sqrt(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
                      real_T *c2_x);
static real_T c2_b_eml_matlab_zlarfg(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, int32_T c2_n, real_T *c2_alpha1, real_T c2_x[3]);
static void c2_d_eml_xscal(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x[3]);
static void c2_c_eml_dlanv2(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance, real_T *c2_a, real_T *c2_b, real_T *c2_c, real_T *c2_d, real_T
  *c2_rt1r, real_T *c2_rt1i, real_T *c2_rt2r, real_T *c2_rt2i, real_T *c2_cs,
  real_T *c2_sn);
static void c2_d_eml_xrot(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[9], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c,
  real_T c2_s);
static void c2_e_eml_xrot(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[9], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c,
  real_T c2_s);
static void c2_f_eml_xrot(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  real_T c2_x[9], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c, real_T c2_s);
static void c2_d_sqrt(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
                      creal_T *c2_x);
static void c2_b_eml_xgemm(SFc2_CollisionStrategiesInstanceStruct *chartInstance,
  creal_T c2_A[9], creal_T c2_B[9], creal_T c2_C[9]);
static void init_dsm_address_info(SFc2_CollisionStrategiesInstanceStruct
  *chartInstance);
  ...
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_CollisionStrategies = 0U;
}
  ...
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_CollisionStrategies;
  ...
  (SFc2_CollisionStrategiesInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_CollisionStrategies = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_CollisionStrategies");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_CollisionStrategies(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_CollisionStrategiesInstanceStruct *chartInstance;
  chartInstance = (SFc2_CollisionStrategiesInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_CollisionStrategies_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_CollisionStrategies), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_CollisionStrategies);
  return c2_y;
}
...
void sf_c2_CollisionStrategies_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_CollisionStrategies_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_CollisionStrategies_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_CollisionStrategies_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_CollisionStrategies(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_CollisionStrategies\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_CollisionStrategies_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_CollisionStrategiesInstanceStruct *)
...
static void sf_opaque_initialize_c2_CollisionStrategies(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_CollisionStrategiesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_CollisionStrategies
    ((SFc2_CollisionStrategiesInstanceStruct*) chartInstanceVar);
  initialize_c2_CollisionStrategies((SFc2_CollisionStrategiesInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_CollisionStrategies(void *chartInstanceVar)
{
  enable_c2_CollisionStrategies((SFc2_CollisionStrategiesInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_CollisionStrategies(void *chartInstanceVar)
{
  disable_c2_CollisionStrategies((SFc2_CollisionStrategiesInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_CollisionStrategies(void *chartInstanceVar)
{
  sf_gateway_c2_CollisionStrategies((SFc2_CollisionStrategiesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_CollisionStrategies(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_CollisionStrategies
    ((SFc2_CollisionStrategiesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_CollisionStrategies();/* state var info */
...
extern void sf_internal_set_sim_state_c2_CollisionStrategies(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_CollisionStrategies();/* state var info */
  ...
  set_sim_state_c2_CollisionStrategies((SFc2_CollisionStrategiesInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_CollisionStrategies(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_CollisionStrategies(S);
}

static void sf_opaque_set_sim_state_c2_CollisionStrategies(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_CollisionStrategies(S, st);
}

static void sf_opaque_terminate_c2_CollisionStrategies(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_CollisionStrategiesInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_CollisionStrategies((SFc2_CollisionStrategiesInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_CollisionStrategies((SFc2_CollisionStrategiesInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_CollisionStrategies(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_CollisionStrategies
      ((SFc2_CollisionStrategiesInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_CollisionStrategies(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_CollisionStrategies(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_CollisionStrategies(SimStruct *S)
{
  SFc2_CollisionStrategiesInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_CollisionStrategiesInstanceStruct *)utMalloc(sizeof
    (SFc2_CollisionStrategiesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_CollisionStrategiesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_CollisionStrategies;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_CollisionStrategies;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_CollisionStrategies;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_CollisionStrategies;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_CollisionStrategies;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_CollisionStrategies;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_CollisionStrategies;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_CollisionStrategies;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_CollisionStrategies;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_CollisionStrategies;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_CollisionStrategies;
...
void c2_CollisionStrategies_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_CollisionStrategies(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_CollisionStrategies(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_CollisionStrategies(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_CollisionStrategies_method_dispatcher.\n"
