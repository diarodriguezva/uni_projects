...
public class DataHandler {
	...
	public static final String DataPath = "D:/Dropbox/PAC Simulation Project/Session_2-Hands_on/Data_for_exercises";
...
//				writer.write(String.format("%.3f", jointPos.get(i)) + " ");
	...
	public static String saveJointPosition() {
		String name = RobotController.getControlGui().getJointPosName();
		saveJointPosition(name, RobotController.getInstance().getRobot().getCurrentJointPosition());
		RobotController.getControlGui().setNextJointPosName(getNextJointPosName());
